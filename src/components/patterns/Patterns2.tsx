    ...
    return !this.appService.isInitialized ? (<div/>) : (
      <div>
        <Toolbar>
          ...
          <Button variant="contained" color="primary" onClick={() => this.props.history.push('/patterns-detail/0')}>
            ...
            {this.patternsService.patterns.map(row => (
              <TableRow key={row.ID}>
                ...
                <TableCell>
                  ...
                  <Tooltip title="Edit">
                    <Fab size="small" color="primary" onClick={() => this.props.history.push('/patterns-detail/' + row.ID)}>
